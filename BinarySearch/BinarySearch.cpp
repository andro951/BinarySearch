...
int main() {
	float arr[] = { 4.5, 6, 1, 9.2, 4, 77, 1200, 16.4 };
	float valuesToFind[] = { 4.5, 6, 1, 9.2, 4, 77, 1200, 16.4, 0, 1300, 1.1 };

	int arr2[] = { 1, 1, 1, 1, 1, 1, 0, -9 };
	int valuesToFind2[] = { 1, 0, -9, 2, 3, 4, 5, 6, 7, 8, 9 };

	//First look for the first instance of the value in each of the arrays.
	SortAndTryFindPrintResults(arr, valuesToFind);
	SortAndTryFindPrintResults(arr2, valuesToFind2);

	//Then look for the last instance of the value in each of the arrays.
	SortAndTryFindPrintResults(arr, valuesToFind, false);
	SortAndTryFindPrintResults(arr2, valuesToFind2, false);
}